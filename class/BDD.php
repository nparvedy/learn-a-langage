...
class BDD
{
    ...
    {
        $req = $this->pdo->prepare('UPDATE list_word SET wrong_counter = :wrong_counter, right_counter = :right_counter, wrong_counter_reverse = :wrong_counter_reverse, right_counter_reverse = :right_counter_reverse, success_rate = :success_rate, word_validate = :word_validate, validate_without_word_indice = :validate_without_word_indice WHERE id = :id');
        $req->execute([
